...
import com.aosta.book.web.BookOrderController;
...
privileged aspect BookOrderController_Roo_Controller {
    ...
    public String BookOrderController.update(@Valid BookOrder bookOrder, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, bookOrder);
    ...
    public String BookOrderController.updateForm(@PathVariable("id") Long id, Model uiModel) {
        populateEditForm(uiModel, BookOrder.findBookOrder(id));
        return "bookorders/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String BookOrderController.delete(@PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
